 ...
 * https://gist.github.com/brentini/3158535
 */
...
class Walker_Bootstrap_Menu extends Walker_Nav_Menu {
	...
	function display_element( $element, &$children_elements, $max_depth, $depth = 0, $args, &$output ) {
		...
		// parent::display_element( $element, &$children_elements, $max_depth, $depth, $args, &$output ); // no call-time pass-by-reference
	...
	function start_el( &$output, $item, $depth, $args ) {
		...
		$item_html = '';
		// parent::start_el( &$item_html, $item, $depth, $args ); // no call-time pass-by-reference
